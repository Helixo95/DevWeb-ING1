...
class __TwigTemplate_f1bf2d7d5df0e2e02019343b294827ff extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $__internal_5a27a8ba21ca79b61932376b2fa922d2->enter($__internal_5a27a8ba21ca79b61932376b2fa922d2_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "home/signin.html.twig"));
...
<body>
  ...
  <header>
    ...
    <div id=\"intro\" class=\"bg-image shadow-2-strong\">
      <div class=\"mask d-flex align-items-center h-100\" style=\"background-color: rgba(0, 0, 0, 0.8);\">
          ...
          <div class=\"row justify-content-center\">
            <div class=\"col-xl-5 col-md-8\">
              ...
              <form class=\"bg-white rounded shadow-5-strong p-5\">
                ...
                <div class=\"form-outline mb-4\" data-mdb-input-init>
                    <input type=\"password\" id=\"form1Example2\" class=\"form-control\" />
                    <label class=\"form-label\" for=\"form1Example2\">Confirmation du mot de passe</label>
                  </div>
                <!-- Email input -->
                <div class=\"form-outline mb-4\" data-mdb-input-init>
                    <input type=\"number\" id=\"form1Example1\" class=\"form-control\" />
                    <label class=\"form-label\" for=\"form1Example1\">Numero de telephone</label>
                  </div>
        ...
        // line 96
        echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_profile");
        echo "\" class=\"lien-connexion\">Vous avez déjà un compte? Cliquez ici.</a>
              </form>
            </div>
          </div>
        </div>
  ...
  <!--Footer-->
    ...
    {
        return array (  175 => 119,  149 => 96,  100 => 50,  67 => 20,  57 => 13,  43 => 1,);
    }
    ...
    <nav class=\"navbar navbar-expand-lg navbar-dark d-none d-lg-block\" style=\"z-index: 2000;\">
      <div class=\"container-fluid\">
        ...
        <div class=\"collapse navbar-collapse\" id=\"navbarExample01\">
          <ul class=\"navbar-nav me-auto mb-2 mb-lg-0\">
            <li class=\"nav-item active\">
              <a class=\"nav-link\"  href=\"{{ path('app_profile') }}\">Home</a>
            </li>
          ...
          <div class=\"row justify-content-center\">
            <div class=\"col-xl-5 col-md-8\">
              ...
              <form class=\"bg-white rounded shadow-5-strong p-5\">
                ...
                <!-- Submit button -->
                <button type=\"submit\" class=\"btn btn-primary btn-block\" data-mdb-ripple-init>Sign in</button>
                <a href=\"{{ path('app_profile') }}\" class=\"lien-connexion\">Vous avez déjà un compte? Cliquez ici.</a>
              </form>
            </div>
          </div>
        </div>
...
</html>", "home/signin.html.twig", "C:\\laragon\\www\\DevWeb-ING1\\templates\\home\\signin.html.twig");
    }
}
