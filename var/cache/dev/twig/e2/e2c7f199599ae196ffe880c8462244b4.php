...
class __TwigTemplate_efebe7434f373c36ddb722f02acbfd2e extends Template
{
    private $source;
    private $macros = [];
...
{% for js_asset in assets %}
    ...
    {% endif %}
{% endfor %}
", "@EasyAdmin/includes/_js_assets.html.twig", "/home/cytech/PhpstormProjects/DevWeb-ING1/vendor/easycorp/easyadmin-bundle/src/Resources/views/includes/_js_assets.html.twig");
    }
}
