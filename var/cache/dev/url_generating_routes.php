...
return [
    ...
    'cart_Min' => [['id'], ['_controller' => 'App\\Controller\\CartController::c4rt_Min'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/cart/min']], [], [], []],
    ...
    'app_product_category_brand' => [['category'], ['_controller' => 'App\\Controller\\ProductController::categoryBrand'], [], [['variable', '/', '[^/]++', 'category', true], ['text', '/product']], [], [], []],
