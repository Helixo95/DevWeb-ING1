...
<<<<<<<< HEAD:var/cache/dev/ContainerTKvOi1f/getRegistrationControllerService.php
namespace ContainerTKvOi1f;

========
namespace ContainerEUG0bel;
>>>>>>>> f9e4ba75 (Modification des coordonnées User réussi + Ajout du JS pour les erreurs):var/cache/dev/ContainerEUG0bel/getRegistrationControllerService.php
...
class getRegistrationControllerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $container->services['App\\Controller\\RegistrationController'] = $instance = new \App\Controller\RegistrationController(($container->privates['App\\Service\\BrandService'] ?? $container->load('getBrandServiceService')));
