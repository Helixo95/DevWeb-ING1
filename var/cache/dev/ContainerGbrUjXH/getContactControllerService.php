...
<<<<<<<< HEAD:var/cache/dev/ContainerTKvOi1f/getContactControllerService.php
namespace ContainerTKvOi1f;

========
namespace ContainerGbrUjXH;
>>>>>>>> f9e4ba75 (Modification des coordonnées User réussi + Ajout du JS pour les erreurs):var/cache/dev/ContainerGbrUjXH/getContactControllerService.php
...
class getContactControllerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $container->services['App\\Controller\\ContactController'] = $instance = new \App\Controller\ContactController(($container->privates['App\\Service\\BrandService'] ?? $container->load('getBrandServiceService')));
